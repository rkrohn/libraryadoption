...
print("Comarison plot saved to results/activity_analysis/commit_activity_%s.png" % BIN_WIDTH)

#save adopt and non-adopt data to csv
col_header = "time_from_commit_(minutes)"
np.savetxt("results/activity_analysis/commit_activity_data_%s.csv" % BIN_WIDTH, np.column_stack(([col_header] + times, ['adopt_activity'] + non_adopt_activity_avg, ['non_adopt_activity'] + non_adopt_activity_avg)), delimiter=",", fmt="%s")