...
plot_data(comp_data, "Time (UNIX)", "Number of Components", "%s: Number of Components over Time" % lib, filename = "results/%s_time_components_APPROX.png" % lib, x_max = 0, x_min = 0, log_scale = False)
