...
TEST_DAYS = 30		#number of days past random day (including random day) to predict
...
#select a random day as first day of testing month
year = 2017			#always pick a day in 2017
month = random.randint(1, 12)
day = random.randint(1, monthrange(year, month)[1])
testing_start = datetime.datetime(year, month, day)
